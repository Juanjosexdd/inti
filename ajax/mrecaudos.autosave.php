  ...
  _POST(); 
    ...
    switch($_GET["op"]){
      ...
      case "guardaryeditar":
          ...
          $idrecaudos  = isset($_POST["idrecaudos"]);
        ...
        if(empty($idrecaudos)){
          ...
          $datos = $recaudos->get_nombre_recaudos_edit($nombre);
      ...
      case "listar":
        ...
        foreach($datos as $row){
          ...
          $sub_array[] = '<button type="button" onClick="mostrar('.$row["idrecaudos"].');"  id="'.$row["idrecaudos"].'" class="btn btn-warning btn-md update"><i class="glyphicon glyphicon-edit"></i> EDITAR</button>';
