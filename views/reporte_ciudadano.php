                ...
                <div class="modal-body">
                  <div class="form-row">
                    <div class="col-md-5 my-4 offset-md-1">
                      <label>Nombre</label>
                      <input type="text" name="dato" id="dato" class="form-control" placeholder="Ej: Juan soto" required onKeyPress="return soloLetrasConEspacio(event)" />
                    </div>
...
<script>
  function generarpdf(){
      ...
      window.open("http://localhost/inti/reportes/control/c_rptciudadano.php?dato=" + dato + "&estatus=" + estatus);
    }
</script>
