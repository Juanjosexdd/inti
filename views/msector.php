<?php
  ...
  $sql_municipio = $conectar->prepare("SELECT * FROM municipio WHERE estatus = 1");
  $sql_municipio->execute();
  $result_municipio = $sql_municipio->fetchAll();
...
?>
            ...
            <div class="col-md-10 offset-md-1">
              <div class="card card-success card-outline p-2">
                <div class="card-header with-border">
                  <h1 class="box-title">
                  <button class="btn btn-success" id="add_button" onclick="limpiar()" data-toggle="modal" data-target="#sectorModal"> Agregar </button></h1>
                  <div class="box-tools pull-right">
                  </div>
                </div>
                <div class="card-body table-responsive">
                  <table id="sector_data" class="table table-sm table-bordered table-striped">
                    <thead>                              
                      <tr>
                        <th width="6%">#</th>                           
                        <th>Nombre</th>
    ...
    <div  id="sectorModal" class="modal fade">
          ...
          <form method="post" id="sector_form">
            <div class="modal-content card-success card-outline">
              ...
              <div class="modal-body">
                  ...
                  <div class="col-md-10 offset-md-1 my-3">
                    ...
                    <select class="form-control" id="codmunicipio" name="codmunicipio" required onchange="cargarCombo(this.value,this.name,'parroquia','codparroquia','nombre','')">
                        ...
                        foreach ( $result_municipio as $key => $value ) {
                          $seleccionado = "";
                          $opciones    .= "<option value='".$result_municipio[$key]['codmunicipio']."' ".$seleccionado."> ".utf8_encode($result_municipio[$key]['nombre'])." </option>";
                        } echo $opciones;
                        ?>
                    </select>
                  </div>
                ...
                <div class="form-row">
                  <div class="col-md-10 offset-md-1 my-3">
                    <label><code>*</code> &nbsp;Parroquia</label>
              ...
              <div class="modal-footer">
                <input type="hidden" name="codsector" id="codsector"/>
...
?>
<script type="text/javascript" src="js/msector.js"></script>
