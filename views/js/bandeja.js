     ...
     function listar(){
         tabla=$('#tramite_data').dataTable({
             ...
             "ajax":
                     {
                         url: '../ajax/bandeja.php?op=listar',
                         type : "get",
                         dataType : "json",						
                         error: function(e){
     ...
     function mostrar(codtramite){
         $.post("../ajax/bandeja.php?op=mostrar",{codtramite : codtramite}, function(data, status){
     ...
     function guardaryeditar(e){
         ...
         $.ajax({
             url: "../ajax/bandeja.php?op=guardaryeditar",
             type: "POST",
             data: formData,
             contentType: false,
             processData: false,
     ...
     function cambiarEstado(codtramite, est){
          bootbox.confirm("¿Está seguro de cambiar de estatus?", function(result){
             if(result){
                 $.ajax({
                     url:"../ajax/bandeja.php?op=activarydesactivar",
                     method:"POST",
        ...
        function cambiarEstatus(e){
            console.log(location.href="http://localhost/inti/views/bandeja.php?estatus="+e);
        }
        ...
        function guardarProcesar(e){
            ...
            $.ajax({
                url: "../ajax/bandeja.php?op=ProcesarTramite",
                type: "POST",
                data: formData,
                contentType: false,
                processData: false,
        ...
        function guardarAnular(e){
            ...
            $.ajax({
                url: "../ajax/bandeja.php?op=AnularTramite",
                type: "POST",
                data: formData,
                contentType: false,
                processData: false,
        ...
        function listarRecaudos(idtramite,codtramite,ciudadano,tramite,fecha,sector,estatus,observacion){
           ...
           // console.log(idtramite);
            ...
            $.ajax({
                url:"../ajax/bandeja.php?op=cargarRecaudos",
                method:"POST",
                ...
                success: function(data){
                    ...
                    setTimeout(function(){
                        ...
                        $('input').on('ifChecked', function(event){
                            ...
                            $.ajax({
                                url:"../ajax/bandeja.php?op=agregarRecaudos",
                                method:"POST",
                        ...
                        $('input').on('ifUnchecked', function(event){
                            ...
                            $.ajax({
                                url:"../ajax/bandeja.php?op=removerRecaudos",
                                method:"POST",
                                data:{ idtramite:idtramite, idrecaudo:idrecaudo, codtramite:codtramite },
                                dataType:'Json',
                                success: function(data){
