              ...
              <div class="modal-body">
                <div class="form-row">
                  <div class="col-md-10 offset-md-1 my-3">
                    ...
                    <input type="text" name="nombre" id="nombre" class="form-control" placeholder="Ej: Denuncia Tierra Ociosa" required onKeyPress="return soloLetrasConEspacio(event)" />
                  </div>
                </div>
				        <div class="form-row">
                  <div class="col-md-10 offset-md-1 my-3">
                    <label> <code>*</code> &nbsp; Descripción</label>
                    <input type="text" name="descripcion" id="descripcion" class="form-control" placeholder="Ej: Denuncia Tierra Ociosa" required onKeyPress="return soloLetrasConEspacio(event)" />
                  </div>
                </div>
                <br>
          ...
          <div class="modal-content">
            ...
            <div class="form-row">
                ...
                <div class="col-md-5 mb-5">
                  ...
                  <input type="text" name="cantidad" id="cantidad" class="form-control" placeholder="Ej: 2" required onKeyPress="return fnv_soloNumeros(event)" />
                </div>
