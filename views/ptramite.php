<?php
  ...
  $sql_estatus = $conectar->prepare("SELECT * FROM estatus WHERE estatus = 1 ORDER BY codestatus");
  $sql_estatus->execute();
...
<?php
  require_once("header.php");
    ...
    if( $result_rolusuario[0]['nombre'] != 'ADMINISTRADOR' ){
?>
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class='alert alert-danger' role='alert'>
          ...
          <strong>¡Error!</strong> 
            No tiene los permisos necesarios para ver esta vista
        </div>
...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
            ...
            <div class="form-row">
                ...
                <input type="text" name="fechainicio" id="fechainicio" class="form-control datepicker" placeholder="" required onKeyPress="" />
                </div>
...
<!-- /MODAL DE MENSAJES PROCESAR -->
    ...
    <?php  } // Cierre permiso administrador ?>
...
<script type="text/javascript" src="js/ptramite.js"></script>
