                ...
                <div class="modal-body">
                  <div class="form-row">
                    <div class="col-md-5 my-4 offset-md-1">
                      <label>Nombre</label>
                      <input type="text" name="dato" id="dato" class="form-control" placeholder="Ej: Analista Area Legal" required onKeyPress="return soloLetrasConEspacio(event)" />
                    </div>
...
<script>
  function generarpdf(){
      ...
      window.open("http://localhost/inti/reportes/control/c_rptcargo.php?dato=" + dato + "&estatus=" + estatus);
    }
</script>
