                ...
                <div class="modal-body">
                  <div class="form-row">
                    <div class="col-md-6 mb-6">
                      <label>Nombre</label>
                      <input type="text" name="dato" id="dato" class="form-control" placeholder="Ej: Admin" required onKeyPress="return soloLetrasConEspacio(event)" />
                    </div>
...
<script>
  function generarpdf(){
      ...
      window.open("http://localhost/inti/reportes/control/c_rptusuario.php?dato=" + dato + "&estatus=" + estatus);
    }
